...
class ItemWithImage: UICollectionViewCell {
    ...
    lazy var unselectedCircle: UIView = {
        $0.backgroundColor = .clear
        $0.customBorderWidth = 2
        $0.customBorderColor = .white
    ...
    func updateAppearance(forPoint view: UIView) {
        view.frame.size = CGSize(width: unselectedCircle.width - unselectedCircle.customBorderWidth * 2, height: unselectedCircle.height - unselectedCircle.customBorderWidth * 2)
