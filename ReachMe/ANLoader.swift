...
public struct ANLoader {
    ...
    public static var activityBackgroundColor: UIColor = UIColor.black.withAlphaComponent(0.8)
    ...
    fileprivate static var activityWidth = (UIScreen.screenWidth / widthDivision) / 3.5
