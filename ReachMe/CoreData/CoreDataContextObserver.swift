...
//  ReachMe
//
//  Created by Sachin Kumar Patra on 3/1/18.
...
public class CoreDataContextObserver {
    ...
    public init(context: NSManagedObjectContext) {
        ...
        notificationObserver = NotificationCenter.default.addObserver(forName: NSNotification.Name.NSManagedObjectContextObjectsDidChange, object: context, queue: nil) { notification in
